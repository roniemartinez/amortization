...
setup(
    ...
    extras_require={"dev": ["autoflake==1.*,>=1.3.1", "black==22.*,>=22.1.0", "dephell==0.*,>=0.8.3", "isort==5.*,>=5.10.1", "mistune<2.0.0", "mypy==0.*,>=0.941.0", "pyproject-flake8==0.*,>=0.0.1.a2", "pytest==7.*,>=7.0.0", "pytest-cov==3.*,>=3.0.0", "tomlkit==0.7.0", "types-tabulate==0.*,>=0.8.6"]},
)
